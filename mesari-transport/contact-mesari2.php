...
<script language="javascript" src="asset/cal2.js"></script>
<script language="javascript" src="asset/cal_conf2.js"></script>
</head>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td width="800" height="919" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF7D8">
      <!--DWLayoutTable-->
      <tr>
        <td width="210" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="15" height="275">&nbsp;</td>
                      <td width="25" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <!--DWLayoutTable-->
                          <tr>
                            <td width="25" height="275" valign="top"><div id="masterdiv">
                              <div class="bunga"><img src="images/bunga-link.gif" width="13" height="18" /></div>      
                                <div class="bunga"><img src="images/bunga-link.gif" width="13" height="18" /></div>
                                <div class="bunga"><img src="images/bunga-link.gif" width="13" height="18" /></div>      
                                <div class="bunga"><img src="images/bunga-link.gif" width="13" height="18" /></div>
                                <div class="bunga"><img src="images/bunga-link.gif" width="13" height="18" /></div>      
          ...
          <td width="566" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="566" height="30" align="left" valign="middle" class="title">Hubungi Kami - Mesari Transport Tour </td>
              </tr>
              <tr>
                <td height="10"></td>
              </tr>
        ...
        <td height="608">&nbsp;</td>
          <td rowspan="2" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="566" height="74" valign="top" class="content">Untuk keterangan dan informasi lebih lanjut, silahkan menghubungi kami di :<br />
                  <br />
                  <strong>Mesari Transport Tour - Agen Perjalanan Wisata dan Perusahaan Sewa Mobil di Bali</strong><br />
                  Jl.Drupadi No 39x Denpasar Bali
                  <br />
                  Phone. +62 361 8006175
                  Fax +62 361 757166<br />
                Email : <a href="mailto:info@mesari-transport-tour.com">info@mesari-transport-tour.com</a></td>
              </tr>
              <tr>
                <td height="25" valign="top" class="content"> <br />
                  Atau hubungi kami melalui kontak form di bawah ini:<br />
                  (Mohon untuk mengisi setiap field yang ada)<br />
                <br /></td>
              </tr>
              <tr>
                <td height="470" valign="top"><form method="post" action="proses_anti_spam.php" id="request" name="request">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content">
                      <!--DWLayoutTable-->
                      <tr>
                        <td width="29" rowspan="8" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
                        <td width="99" height="25" align="left" valign="middle">Nama</td>
                        <td width="14" align="center" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle"><label><input name="nama" type="text" class="side-left-desc" id="nama" size="45" /> <a href="javascript:showCal('Calendar1')"><img src="images/cal.gif" width="16" height="16" border="0" /></a></label></td>
                      </tr>
                      <tr>
                        <td height="25" align="left" valign="middle">Email</td>
                        <td align="center" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle"><input name="email" type="text" class="side-left-desc" id="email" size="45" />
                        *</td>
                      </tr>
                      <tr>
                        <td height="25" align="left" valign="middle">Alamat</td>
                        <td align="center" valign="middle">:</td>
                        <td colspan="4" align="left" valign="middle"><input name="alamat" type="text" class="side-left-desc" id="alamat" size="45" />
                        *</td>
                      </tr>
                      <tr>
                        <td height="25" align="left" valign="middle">Telepon</td>
                        <td align="center" valign="middle">:</td>
                      ...
                      <tr>
                        <td height="25" align="left" valign="middle">Pesan</td>
                        <td align="center" valign="middle">:</td>
                        <td width="100">&nbsp;</td>
                        <td width="53">&nbsp;</td>
                        <td width="95">&nbsp;</td>
                      ...
                      <tr>
                        <td height="20">&nbsp;</td>
                        <td></td>
                        <td colspan="4" valign="top">Masukkan kode dibawah ini :</td>
                      </tr>
                      <tr>
                        <td height="58">&nbsp;</td>
                        <td></td>
                        <td colspan="4" rowspan="2" align="left" valign="top"><img src="gambar_anti_spam.php"></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="4" valign="middle"><input name="code" type="text" class="side-left-desc"></td>
                      </tr>
                      <tr>
                        <td height="25"></td>
                        <td></td>
                        <td></td>
                        <td align="left" valign="top"><input name="Submit" type="submit" class="side-left-desc" value="Kirim Pesan" /></td>
                        <td align="left" valign="top"><input name="Submit2" type="reset" class="side-left-desc" value="Hapus" /></td>
              ...
              <tr>
                <td height="101" valign="top"><a href="harga-sewa-mobil-mesari.php"><img src="images/deret-mobil.jpg" width="566" height="100" border="0" /></a></td>
              </tr>
                                      </table></td>
        </tr>
      <tr>
