    ...
    <td width="800" height="662" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFF7D8">
      ...
      <tr>
        ...
        <td width="566" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="566" height="30" align="left" valign="middle" class="title">Profil Mesari Transport Tour </td>
              </tr>
              <tr>
                <td height="10"></td>
              </tr>
        ...
        <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="566" height="522" valign="top">
			  ...
			  echo"<tr><td colspan='4' class='content'><b>Mesari Transport Tour Special Offer :</b><br><br></td></tr>";
